...
export const FILL_DEADLINE_MS = 30 * 1000; // 30 seconds
export const TURN_TIMER_MS = 10 * 1000;         // 10 seconds (real players)
export const AI_TURN_TIMER_MS = 3 * 1000;       // 3 seconds (AI players)
